...
# Form implementation generated from reading ui file 'priscoreslist3rd.ui'
#
...
class Ui_PriScore3rdForm(object):
    def setupUi(self, PriScore3rdForm):
        PriScore3rdForm.setObjectName("PriScore3rdForm")
        PriScore3rdForm.resize(1074, 721)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("score2_icon.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        PriScore3rdForm.setWindowIcon(icon)
        PriScore3rdForm.setStyleSheet("font: 12pt \"MS Shell Dlg 2\";\n"
"\n"
"QPushButton{\n"
"background-color: rgb(170, 255, 127);\n"
"}")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(PriScore3rdForm)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout()
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.switch_back_btn = QtWidgets.QPushButton(PriScore3rdForm)
        ...
        self.tableWidget = QtWidgets.QTableWidget(PriScore3rdForm)
        ...
        self.tableWidget_2 = QtWidgets.QTableWidget(PriScore3rdForm)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.del_btn = QtWidgets.QPushButton(PriScore3rdForm)
        ...
        self.class_comboBox = QtWidgets.QComboBox(PriScore3rdForm)
        ...
        self.stud_adm_no_comboBox = QtWidgets.QComboBox(PriScore3rdForm)
        ...
        self.name_label = QtWidgets.QLabel(PriScore3rdForm)
        self.name_label.setText("")
        self.name_label.setObjectName("name_label")
        self.verticalLayout.addWidget(self.name_label)
        self.groupBox = QtWidgets.QGroupBox(PriScore3rdForm)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(PriScore3rdForm)
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(PriScore3rdForm)
        ...
        self.report_gen_btn = QtWidgets.QPushButton(PriScore3rdForm)
        ...
        self.retranslateUi(PriScore3rdForm)
        QtCore.QMetaObject.connectSlotsByName(PriScore3rdForm)

    def retranslateUi(self, PriScore3rdForm):
        _translate = QtCore.QCoreApplication.translate
        PriScore3rdForm.setWindowTitle(_translate("PriScore3rdForm", "Primary Classes Scores (Third Term)"))
        self.switch_back_btn.setText(_translate("PriScore3rdForm", "Switch back to all classes"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("PriScore3rdForm", "Row/No"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("PriScore3rdForm", "Admission No"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("PriScore3rdForm", "Class"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("PriScore3rdForm", "Quran(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("PriScore3rdForm", "Quran(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("PriScore3rdForm", "Quran(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("PriScore3rdForm", "Quran(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("PriScore3rdForm", "Quran(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(8)
        item.setText(_translate("PriScore3rdForm", "Ibadat(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(9)
        item.setText(_translate("PriScore3rdForm", "Ibadat(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(10)
        item.setText(_translate("PriScore3rdForm", "Ibadat(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(11)
        item.setText(_translate("PriScore3rdForm", "Ibadat(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(12)
        item.setText(_translate("PriScore3rdForm", "Ibadat(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(13)
        item.setText(_translate("PriScore3rdForm", "Arabic(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(14)
        item.setText(_translate("PriScore3rdForm", "Arabic(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(15)
        item.setText(_translate("PriScore3rdForm", "Arabic(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(16)
        item.setText(_translate("PriScore3rdForm", "Arabic(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(17)
        item.setText(_translate("PriScore3rdForm", "Arabic(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(18)
        item.setText(_translate("PriScore3rdForm", "English(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(19)
        item.setText(_translate("PriScore3rdForm", "English(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(20)
        item.setText(_translate("PriScore3rdForm", "English(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(21)
        item.setText(_translate("PriScore3rdForm", "English(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(22)
        item.setText(_translate("PriScore3rdForm", "English(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(23)
        item.setText(_translate("PriScore3rdForm", "Maths(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(24)
        item.setText(_translate("PriScore3rdForm", "Maths(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(25)
        item.setText(_translate("PriScore3rdForm", "Maths(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(26)
        item.setText(_translate("PriScore3rdForm", "Maths(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(27)
        item.setText(_translate("PriScore3rdForm", "Maths(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(28)
        item.setText(_translate("PriScore3rdForm", "Science(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(29)
        item.setText(_translate("PriScore3rdForm", "Science(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(30)
        item.setText(_translate("PriScore3rdForm", "Science(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(31)
        item.setText(_translate("PriScore3rdForm", "Science(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(32)
        item.setText(_translate("PriScore3rdForm", "Science(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(33)
        item.setText(_translate("PriScore3rdForm", "Social Norm(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(34)
        item.setText(_translate("PriScore3rdForm", "Social Norm(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(35)
        item.setText(_translate("PriScore3rdForm", "Social Norm(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(36)
        item.setText(_translate("PriScore3rdForm", "Social Norm(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(37)
        item.setText(_translate("PriScore3rdForm", "Social Norm(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(38)
        item.setText(_translate("PriScore3rdForm", "Handwriting(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(39)
        item.setText(_translate("PriScore3rdForm", "Handwriting(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(40)
        item.setText(_translate("PriScore3rdForm", "Handwriting(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(41)
        item.setText(_translate("PriScore3rdForm", "Handwriting(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(42)
        item.setText(_translate("PriScore3rdForm", "Handwriting(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(43)
        item.setText(_translate("PriScore3rdForm", "All Total"))
        item = self.tableWidget.horizontalHeaderItem(44)
        item.setText(_translate("PriScore3rdForm", "Average"))
        ...
        item.setText(_translate("PriScore3rdForm", "Average"))
        self.del_btn.setText(_translate("PriScore3rdForm", "Delete Student"))
        self.groupBox.setTitle(_translate("PriScore3rdForm", "Attendance"))
        self.att_a_radio.setText(_translate("PriScore3rdForm", "A"))
        self.att_e_radio.setText(_translate("PriScore3rdForm", "E"))
        self.att_d_radio.setText(_translate("PriScore3rdForm", "D"))
        self.att_c_radio.setText(_translate("PriScore3rdForm", "C"))
        self.att_b_radio.setText(_translate("PriScore3rdForm", "B"))
        self.groupBox_2.setTitle(_translate("PriScore3rdForm", "Conduct"))
        self.con_a_radio.setText(_translate("PriScore3rdForm", "A"))
        self.con_b_radio.setText(_translate("PriScore3rdForm", "B"))
        self.con_c_radio.setText(_translate("PriScore3rdForm", "C"))
        self.con_d_radio.setText(_translate("PriScore3rdForm", "D"))
        self.con_e_radio.setText(_translate("PriScore3rdForm", "E"))
        self.groupBox_3.setTitle(_translate("PriScore3rdForm", "Neatness"))
        self.neat_a_radio.setText(_translate("PriScore3rdForm", "A"))
        self.neat_b_radio.setText(_translate("PriScore3rdForm", "B"))
        self.neat_c_radio.setText(_translate("PriScore3rdForm", "C"))
        self.neat_d_radio.setText(_translate("PriScore3rdForm", "D"))
        self.neat_e_radio.setText(_translate("PriScore3rdForm", "E"))
        self.report_gen_btn.setText(_translate("PriScore3rdForm", "Generate selected student report"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    PriScore3rdForm = QtWidgets.QWidget()
    ui = Ui_PriScore3rdForm()
    ui.setupUi(PriScore3rdForm)
    PriScore3rdForm.show()
    sys.exit(app.exec_())
