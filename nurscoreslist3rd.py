...
class Ui_NurScore3rdForm(object):
    def setupUi(self, NurScore3rdForm):
        ...
        NurScore3rdForm.resize(1074, 721)
        icon = QtGui.QIcon()
...
"}")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(NurScore3rdForm)
    ...
    def retranslateUi(self, NurScore3rdForm):
        ...
        self.switch_back_btn.setText(_translate("NurScore3rdForm", "Switch back to all classes"))
        ...
        item.setText(_translate("NurScore3rdForm", "Average"))
        self.del_btn.setText(_translate("NurScore3rdForm", "Delete Student"))
        ...
        self.report_gen_btn.setText(_translate("NurScore3rdForm", "Generate selected student report"))
