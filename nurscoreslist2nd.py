...
class Ui_NurScore2ndForm(object):
    def setupUi(self, NurScore2ndForm):
        ...
        NurScore2ndForm.resize(1074, 721)
        icon = QtGui.QIcon()
...
"}")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(NurScore2ndForm)
    ...
    def retranslateUi(self, NurScore2ndForm):
        ...
        self.switch_back_btn.setText(_translate("NurScore2ndForm", "Switch back to all classes"))
        ...
        item.setText(_translate("NurScore2ndForm", "Average"))
        self.del_btn.setText(_translate("NurScore2ndForm", "Delete Student"))
        ...
        self.report_gen_btn.setText(_translate("NurScore2ndForm", "Generate selected student report"))
