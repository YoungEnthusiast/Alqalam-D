...
# Form implementation generated from reading ui file 'priscoreslist2nd.ui'
#
...
class Ui_PriScore2ndForm(object):
    def setupUi(self, PriScore2ndForm):
        PriScore2ndForm.setObjectName("PriScore2ndForm")
        PriScore2ndForm.resize(1074, 721)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("score2_icon.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        PriScore2ndForm.setWindowIcon(icon)
        PriScore2ndForm.setStyleSheet("font: 12pt \"MS Shell Dlg 2\";\n"
"\n"
"QPushButton{\n"
"background-color: rgb(170, 255, 127);\n"
"}")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(PriScore2ndForm)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout()
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.switch_back_btn = QtWidgets.QPushButton(PriScore2ndForm)
        ...
        self.tableWidget = QtWidgets.QTableWidget(PriScore2ndForm)
        ...
        self.tableWidget_2 = QtWidgets.QTableWidget(PriScore2ndForm)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.del_btn = QtWidgets.QPushButton(PriScore2ndForm)
        ...
        self.class_comboBox = QtWidgets.QComboBox(PriScore2ndForm)
        ...
        self.stud_adm_no_comboBox = QtWidgets.QComboBox(PriScore2ndForm)
        ...
        self.name_label = QtWidgets.QLabel(PriScore2ndForm)
        self.name_label.setText("")
        self.name_label.setObjectName("name_label")
        self.verticalLayout.addWidget(self.name_label)
        self.groupBox = QtWidgets.QGroupBox(PriScore2ndForm)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(PriScore2ndForm)
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(PriScore2ndForm)
        ...
        self.report_gen_btn = QtWidgets.QPushButton(PriScore2ndForm)
        ...
        self.retranslateUi(PriScore2ndForm)
        QtCore.QMetaObject.connectSlotsByName(PriScore2ndForm)

    def retranslateUi(self, PriScore2ndForm):
        _translate = QtCore.QCoreApplication.translate
        PriScore2ndForm.setWindowTitle(_translate("PriScore2ndForm", "Primary Classes Scores (Second Term)"))
        self.switch_back_btn.setText(_translate("PriScore2ndForm", "Switch back to all classes"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("PriScore2ndForm", "Row/No"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("PriScore2ndForm", "Admission No"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("PriScore2ndForm", "Class"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("PriScore2ndForm", "Quran(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("PriScore2ndForm", "Quran(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("PriScore2ndForm", "Quran(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("PriScore2ndForm", "Quran(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("PriScore2ndForm", "Quran(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(8)
        item.setText(_translate("PriScore2ndForm", "Ibadat(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(9)
        item.setText(_translate("PriScore2ndForm", "Ibadat(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(10)
        item.setText(_translate("PriScore2ndForm", "Ibadat(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(11)
        item.setText(_translate("PriScore2ndForm", "Ibadat(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(12)
        item.setText(_translate("PriScore2ndForm", "Ibadat(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(13)
        item.setText(_translate("PriScore2ndForm", "Arabic(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(14)
        item.setText(_translate("PriScore2ndForm", "Arabic(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(15)
        item.setText(_translate("PriScore2ndForm", "Arabic(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(16)
        item.setText(_translate("PriScore2ndForm", "Arabic(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(17)
        item.setText(_translate("PriScore2ndForm", "Arabic(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(18)
        item.setText(_translate("PriScore2ndForm", "English(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(19)
        item.setText(_translate("PriScore2ndForm", "English(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(20)
        item.setText(_translate("PriScore2ndForm", "English(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(21)
        item.setText(_translate("PriScore2ndForm", "English(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(22)
        item.setText(_translate("PriScore2ndForm", "English(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(23)
        item.setText(_translate("PriScore2ndForm", "Maths(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(24)
        item.setText(_translate("PriScore2ndForm", "Maths(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(25)
        item.setText(_translate("PriScore2ndForm", "Maths(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(26)
        item.setText(_translate("PriScore2ndForm", "Maths(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(27)
        item.setText(_translate("PriScore2ndForm", "Maths(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(28)
        item.setText(_translate("PriScore2ndForm", "Science(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(29)
        item.setText(_translate("PriScore2ndForm", "Science(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(30)
        item.setText(_translate("PriScore2ndForm", "Science(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(31)
        item.setText(_translate("PriScore2ndForm", "Science(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(32)
        item.setText(_translate("PriScore2ndForm", "Science(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(33)
        item.setText(_translate("PriScore2ndForm", "Social Norm(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(34)
        item.setText(_translate("PriScore2ndForm", "Social Norm(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(35)
        item.setText(_translate("PriScore2ndForm", "Social Norm(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(36)
        item.setText(_translate("PriScore2ndForm", "Social Norm(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(37)
        item.setText(_translate("PriScore2ndForm", "Social Norm(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(38)
        item.setText(_translate("PriScore2ndForm", "Handwriting(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(39)
        item.setText(_translate("PriScore2ndForm", "Handwriting(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(40)
        item.setText(_translate("PriScore2ndForm", "Handwriting(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(41)
        item.setText(_translate("PriScore2ndForm", "Handwriting(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(42)
        item.setText(_translate("PriScore2ndForm", "Handwriting(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(43)
        item.setText(_translate("PriScore2ndForm", "All Total"))
        item = self.tableWidget.horizontalHeaderItem(44)
        item.setText(_translate("PriScore2ndForm", "Average"))
        ...
        item.setText(_translate("PriScore2ndForm", "Average"))
        self.del_btn.setText(_translate("PriScore2ndForm", "Delete Student"))
        self.groupBox.setTitle(_translate("PriScore2ndForm", "Attendance"))
        self.att_a_radio.setText(_translate("PriScore2ndForm", "A"))
        self.att_e_radio.setText(_translate("PriScore2ndForm", "E"))
        self.att_d_radio.setText(_translate("PriScore2ndForm", "D"))
        self.att_c_radio.setText(_translate("PriScore2ndForm", "C"))
        self.att_b_radio.setText(_translate("PriScore2ndForm", "B"))
        self.groupBox_2.setTitle(_translate("PriScore2ndForm", "Conduct"))
        self.con_a_radio.setText(_translate("PriScore2ndForm", "A"))
        self.con_b_radio.setText(_translate("PriScore2ndForm", "B"))
        self.con_c_radio.setText(_translate("PriScore2ndForm", "C"))
        self.con_d_radio.setText(_translate("PriScore2ndForm", "D"))
        self.con_e_radio.setText(_translate("PriScore2ndForm", "E"))
        self.groupBox_3.setTitle(_translate("PriScore2ndForm", "Neatness"))
        self.neat_a_radio.setText(_translate("PriScore2ndForm", "A"))
        self.neat_b_radio.setText(_translate("PriScore2ndForm", "B"))
        self.neat_c_radio.setText(_translate("PriScore2ndForm", "C"))
        self.neat_d_radio.setText(_translate("PriScore2ndForm", "D"))
        self.neat_e_radio.setText(_translate("PriScore2ndForm", "E"))
        self.report_gen_btn.setText(_translate("PriScore2ndForm", "Generate selected student report"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    PriScore2ndForm = QtWidgets.QWidget()
    ui = Ui_PriScore2ndForm()
    ui.setupUi(PriScore2ndForm)
    PriScore2ndForm.show()
    sys.exit(app.exec_())
