...
class Ui_NurScoreRec2ndForm(object):
    def setupUi(self, NurScoreRec2ndForm):
        ...
        NurScoreRec2ndForm.resize(985, 679)
        icon = QtGui.QIcon()
...
"}")
        ...
        self.social_score_btn = QtWidgets.QPushButton(NurScoreRec2ndForm)
        ...
        self.handwriting_score_btn = QtWidgets.QPushButton(NurScoreRec2ndForm)
        ...
        self.gridLayout.addItem(spacerItem2, 25, 1, 1, 1)
        ...
        self.gridLayout.addItem(spacerItem3, 26, 1, 1, 1)
        ...
        self.tot_avg_btn = QtWidgets.QPushButton(NurScoreRec2ndForm)
...
"")
        ...
        self.math_score_btn = QtWidgets.QPushButton(NurScoreRec2ndForm)
        ...
        self.nur_sc_c2_spin = QtWidgets.QDoubleSpinBox(NurScoreRec2ndForm)
        ...
        self.gridLayout.addItem(spacerItem4, 18, 1, 1, 1)
        self.nur_sc_ass_spin = QtWidgets.QDoubleSpinBox(NurScoreRec2ndForm)
        ...
        self.nur_sc_score_btn = QtWidgets.QPushButton(NurScoreRec2ndForm)
        ...
        self.gridLayout.addItem(spacerItem5, 21, 1, 1, 1)
        ...
        self.nur_sc_exam_spin = QtWidgets.QDoubleSpinBox(NurScoreRec2ndForm)
        ...
        self.nur_sc_c1_spin = QtWidgets.QDoubleSpinBox(NurScoreRec2ndForm)
        ...
        self.ibadat_exam_spin = QtWidgets.QDoubleSpinBox(NurScoreRec2ndForm)
        ...
        self.arabic_c1_spin = QtWidgets.QDoubleSpinBox(NurScoreRec2ndForm)
        ...
        self.qur_c1_spin = QtWidgets.QDoubleSpinBox(NurScoreRec2ndForm)
        ...
        self.ibadat_ass_spin = QtWidgets.QDoubleSpinBox(NurScoreRec2ndForm)
        ...
        self.arabic_c2_spin = QtWidgets.QDoubleSpinBox(NurScoreRec2ndForm)
        ...
        self.ibadat_score_btn = QtWidgets.QPushButton(NurScoreRec2ndForm)
        ...
        self.ibadat_c1_spin = QtWidgets.QDoubleSpinBox(NurScoreRec2ndForm)
        ...
        self.gridLayout.addItem(spacerItem11, 8, 1, 1, 1)
        self.arabic_ass_spin = QtWidgets.QDoubleSpinBox(NurScoreRec2ndForm)
        ...
        self.qur_exam_spin = QtWidgets.QDoubleSpinBox(NurScoreRec2ndForm)
        ...
        self.ibadat_c2_spin = QtWidgets.QDoubleSpinBox(NurScoreRec2ndForm)
        ...
        self.arabic_exam_spin = QtWidgets.QDoubleSpinBox(NurScoreRec2ndForm)
        ...
        self.qur_c2_spin = QtWidgets.QDoubleSpinBox(NurScoreRec2ndForm)
        ...
        self.qur_ass_spin = QtWidgets.QDoubleSpinBox(NurScoreRec2ndForm)
        ...
        self.gridLayout.addItem(spacerItem12, 13, 1, 1, 1)
        ...
        self.eng_score_btn = QtWidgets.QPushButton(NurScoreRec2ndForm)
        ...
        self.arabic_score_btn = QtWidgets.QPushButton(NurScoreRec2ndForm)
    ...
    def retranslateUi(self, NurScoreRec2ndForm):
        ...
        self.social_score_btn.setText(_translate("NurScoreRec2ndForm", "Save"))
        self.handwriting_score_btn.setText(_translate("NurScoreRec2ndForm", "Save"))
        self.tot_avg_btn.setText(_translate("NurScoreRec2ndForm", "Compute Total and Average for All"))
        self.label_28.setText(_translate("NurScoreRec2ndForm", "Handwriting"))
        self.math_score_btn.setText(_translate("NurScoreRec2ndForm", "Save"))
        self.label_19.setText(_translate("NurScoreRec2ndForm", "Nursery Science"))
        self.nur_sc_score_btn.setText(_translate("NurScoreRec2ndForm", "Save"))
        self.label_16.setText(_translate("NurScoreRec2ndForm", "Social Norms"))
        self.label_2.setText(_translate("NurScoreRec2ndForm", "Ibadat"))
        self.label_3.setText(_translate("NurScoreRec2ndForm", "Arabic Language"))
        self.ibadat_score_btn.setText(_translate("NurScoreRec2ndForm", "Save"))
        self.label.setText(_translate("NurScoreRec2ndForm", "Quran"))
        ...
        self.label_7.setText(_translate("NurScoreRec2ndForm", "ASS"))
        self.qur_score_btn.setText(_translate("NurScoreRec2ndForm", "Save"))
        self.label_21.setText(_translate("NurScoreRec2ndForm", "English"))
        self.label_20.setText(_translate("NurScoreRec2ndForm", "Mathematics"))
        self.eng_score_btn.setText(_translate("NurScoreRec2ndForm", "Save"))
        self.arabic_score_btn.setText(_translate("NurScoreRec2ndForm", "Save"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    NurScoreRec2ndForm = QtWidgets.QWidget()
    ui = Ui_NurScoreRec2ndForm()
    ui.setupUi(NurScoreRec2ndForm)
    NurScoreRec2ndForm.show()
    sys.exit(app.exec_())
