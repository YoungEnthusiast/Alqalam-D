...
class Ui_SecScore2ndForm(object):
    def setupUi(self, SecScore2ndForm):
        ...
        SecScore2ndForm.resize(1074, 721)
        icon = QtGui.QIcon()
...
"}")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(SecScore2ndForm)
    ...
    def retranslateUi(self, SecScore2ndForm):
        ...
        self.switch_back_btn.setText(_translate("SecScore2ndForm", "Switch back to all classes"))
        ...
        item.setText(_translate("SecScore2ndForm", "Science(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(29)
        item.setText(_translate("SecScore2ndForm", "Science(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(30)
        item.setText(_translate("SecScore2ndForm", "Science(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(31)
        item.setText(_translate("SecScore2ndForm", "Science(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(32)
        item.setText(_translate("SecScore2ndForm", "Science(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(33)
        item.setText(_translate("SecScore2ndForm", "Social Norm(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(34)
        item.setText(_translate("SecScore2ndForm", "Social Norm(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(35)
        item.setText(_translate("SecScore2ndForm", "Social Norm(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(36)
        item.setText(_translate("SecScore2ndForm", "Social Norm(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(37)
        item.setText(_translate("SecScore2ndForm", "Social Norm(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(38)
        item.setText(_translate("SecScore2ndForm", "Handwriting(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(39)
        item.setText(_translate("SecScore2ndForm", "Handwriting(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(40)
        item.setText(_translate("SecScore2ndForm", "Handwriting(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(41)
        item.setText(_translate("SecScore2ndForm", "Handwriting(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(42)
        item.setText(_translate("SecScore2ndForm", "Handwriting(TOTAL)"))
        ...
        item.setText(_translate("SecScore2ndForm", "Average"))
        self.del_btn.setText(_translate("SecScore2ndForm", "Delete Student"))
        ...
        self.report_gen_btn.setText(_translate("SecScore2ndForm", "Generate selected student report"))
