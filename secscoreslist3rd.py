...
class Ui_SecScore3rdForm(object):
    def setupUi(self, SecScore3rdForm):
        ...
        SecScore3rdForm.resize(1074, 721)
        icon = QtGui.QIcon()
...
"}")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(SecScore3rdForm)
    ...
    def retranslateUi(self, SecScore3rdForm):
        ...
        self.switch_back_btn.setText(_translate("SecScore3rdForm", "Switch back to all classes"))
        ...
        item.setText(_translate("SecScore3rdForm", "Science(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(29)
        item.setText(_translate("SecScore3rdForm", "Science(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(30)
        item.setText(_translate("SecScore3rdForm", "Science(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(31)
        item.setText(_translate("SecScore3rdForm", "Science(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(32)
        item.setText(_translate("SecScore3rdForm", "Science(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(33)
        item.setText(_translate("SecScore3rdForm", "Social Norm(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(34)
        item.setText(_translate("SecScore3rdForm", "Social Norm(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(35)
        item.setText(_translate("SecScore3rdForm", "Social Norm(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(36)
        item.setText(_translate("SecScore3rdForm", "Social Norm(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(37)
        item.setText(_translate("SecScore3rdForm", "Social Norm(TOTAL)"))
        item = self.tableWidget.horizontalHeaderItem(38)
        item.setText(_translate("SecScore3rdForm", "Handwriting(CA1)"))
        item = self.tableWidget.horizontalHeaderItem(39)
        item.setText(_translate("SecScore3rdForm", "Handwriting(CA2)"))
        item = self.tableWidget.horizontalHeaderItem(40)
        item.setText(_translate("SecScore3rdForm", "Handwriting(ASS)"))
        item = self.tableWidget.horizontalHeaderItem(41)
        item.setText(_translate("SecScore3rdForm", "Handwriting(EXAM)"))
        item = self.tableWidget.horizontalHeaderItem(42)
        item.setText(_translate("SecScore3rdForm", "Handwriting(TOTAL)"))
        ...
        item.setText(_translate("SecScore3rdForm", "Average"))
        self.del_btn.setText(_translate("SecScore3rdForm", "Delete Student"))
        ...
        self.report_gen_btn.setText(_translate("SecScore3rdForm", "Generate selected student report"))
